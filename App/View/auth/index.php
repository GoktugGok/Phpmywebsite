...
<link href="public/css/bootstrap.min.css" rel="stylesheet">
  ...
  <form id="login">
    ...
    <a href="<?=_link('register')?>" class="text-decoration-none text-white btn btn-lg btn-primary mt-2 w-100">Register</a>
    <div class="col-12">
    <a href="<?=_link('kurtarma')?>" type="submit" class="mt-3 text-dark" style="width: 50%; text-decoration: none;">şifremi unuttum</a>
      </div>
...
<script src="https://cdnjs.cloudflare.com/ajax/libs/axios/1.2.3/axios.min.js" integrity="sha512-L4lHq2JI/GoKsERT8KYa72iCwfSrKYWEyaBxzJeeITM9Lub5vlTj8tufqYk056exhjo2QDEipJrg6zen/DDtoQ==" crossorigin="anonymous" referrerpolicy="no-referrer"></script>
    <script>
      ...
      login.addEventListener('submit',(e) =>{
        ...
        axios.post('<?= _link('giris')?>',formData)
        .then(res => {
